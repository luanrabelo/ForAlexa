...
$query = ("SELECT * FROM `Questions` WHERE IntentName = 'LaunchRequest' and key_user = '$key'");
...
$query = ("SELECT * FROM `Questions` WHERE key_user = '$key' and IntentName != 'LaunchRequest' and IntentName != 'IntentReflector' and IntentName != 'Error'");
$result = $mysqli->query($query);
while ($row = $result->fetch_assoc()) {
$samples  = '[';
