...
<div class="mt-5">
<div class="text-white"><h2>Questions and Answers</h2></div>
...
<input name="Utterance_1" type="text" required="required" class="form-control form-control-lg w-75 mx-auto" id="Utterance_1" value="<?php if ($action == "Update") {echo($Utterances_1);}?>" aria-describedby="Invocation" oninvalid="this.setCustomValidity('Field Invocation Name is required with minimum 5 characters')" oninput="setCustomValidity('')" minlength="5">
...
<div class="mt-5 end text-white" style="display:none" id="end">Skill will be terminated after the response</div>		
